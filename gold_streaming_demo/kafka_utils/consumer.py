...
def save_to_s3(s3: S3FileSystem, data: Dict[str, Any], config: S3Config, count: int) -> None:
...
def process_messages(consumer: KafkaConsumer, s3: S3FileSystem, config: S3Config) -> None:
